<template>
  <li
    ...
    <div
      ...
      <!-- <i
        :class="expanded ? styles.typeIcon.active.class : styles.typeIcon.class"
        :style="selected ? styles.typeIcon.active.style : styles.typeIcon.style">
      </i> -->
      <!-- <span
        data-placement="top"
        :style="selected ? styles.title.active.style : styles.title.style" >
        {{ node.sortCord }}
      </span> -->
      <span
        data-toggle="tooltip"
        ...
        v-bind:class="[{'selected': selected}, styles.title.class]"
        :style="selected ? styles.title.active.style : styles.title.style"
      ...
      >
      <!-- <i
        :class="expanded ? styles.statusIcon.active.class : styles.statusIcon.class"
        :style="selected ? styles.statusIcon.active.style : styles.statusIcon.style">
      </i> -->
      <span
...
.type_icon_active:before {
  content: '♥';
}
.status_icon:before {
  content: '\21E6';
}
.status_icon_active:before {
  content: '\21E6';
}
